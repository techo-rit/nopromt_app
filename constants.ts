...
const celebrationTemplates: Template[] = [
    ...
    },
    {
      ...
      prompt: "Make sure the background of the output image is not blurry and the output image has clearly visible background objects. Ensure the output figure's face matches sharply with the input figure's face, preserving the exact chin shape and jawline without rounding.A real documentary-style photo of the person from the input image celebrating Holi in a real street setting. The person keeps the same face structure as the input (jawline, eyes, nose, lips, eyebrows, natural skin texture). Expression natural, not posed or exaggerated. The environment is a normal Indian street with real people celebrating Holi. Natural amounts of color powder on skin and clothes — nothing excessive or unreal. People in the background look normal, not staged. Natural daylight. No magical color clouds, no artificial particles, no glow effects, no saturated fantasy colors. Full depth of field: everything sharp, no background blur, no portrait mode look. Documentary realism, looks like a real photograph taken during a real Holi event. A real documentary-style photo of the person from the input image celebrating Holi in a real street setting. The person keeps the same face structure as the input (jawline, eyes, nose, lips, eyebrows, natural skin texture). Expression natural, not posed or exaggerated. The environment is a normal Indian street with real people celebrating Holi. Natural amounts of color powder on skin and clothes — nothing excessive or unreal. People in the background look normal, not staged. Natural daylight. No magical color clouds, no artificial particles, no glow effects, no saturated fantasy colors. Full depth of field: everything sharp, no background blur, no portrait mode look. Documentary realism, looks like a real photograph taken during a real Holi event.",
      aspectRatio: '3:4',
    },
    {
